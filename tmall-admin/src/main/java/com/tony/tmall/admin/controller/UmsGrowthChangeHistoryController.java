...
import com.tony.tmall.service.UmsGrowthChangeHistoryService;
 ...
 */
@RestController
@RequestMapping("tmall/umsgrowthchangehistory")
public class UmsGrowthChangeHistoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("tmall:umsgrowthchangehistory:list")
    ...
    //@RequiresPermissions("tmall:umsgrowthchangehistory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("tmall:umsgrowthchangehistory:save")
    ...
    //@RequiresPermissions("tmall:umsgrowthchangehistory:update")
    ...
    //@RequiresPermissions("tmall:umsgrowthchangehistory:delete")

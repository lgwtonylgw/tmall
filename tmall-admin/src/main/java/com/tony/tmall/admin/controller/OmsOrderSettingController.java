 ...
 */
@RestController
@RequestMapping("tmall/omsordersetting")
public class OmsOrderSettingController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("tmall:omsordersetting:list")
    ...
    //@RequiresPermissions("tmall:omsordersetting:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("tmall:omsordersetting:save")
    ...
    //@RequiresPermissions("tmall:omsordersetting:update")
    ...
    //@RequiresPermissions("tmall:omsordersetting:delete")

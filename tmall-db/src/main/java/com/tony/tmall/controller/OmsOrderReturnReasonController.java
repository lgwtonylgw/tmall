 ...
 */
@RestController
@RequestMapping("tmall/omsorderreturnreason")
public class OmsOrderReturnReasonController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("tmall:omsorderreturnreason:list")
    ...
    //@RequiresPermissions("tmall:omsorderreturnreason:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("tmall:omsorderreturnreason:save")
    ...
    //@RequiresPermissions("tmall:omsorderreturnreason:update")
    ...
    //@RequiresPermissions("tmall:omsorderreturnreason:delete")

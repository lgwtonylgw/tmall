...
import com.tony.tmall.service.UmsMemberStatisticsInfoService;
 ...
 */
@RestController
@RequestMapping("tmall/umsmemberstatisticsinfo")
public class UmsMemberStatisticsInfoController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("tmall:umsmemberstatisticsinfo:list")
    ...
    //@RequiresPermissions("tmall:umsmemberstatisticsinfo:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("tmall:umsmemberstatisticsinfo:save")
    ...
    //@RequiresPermissions("tmall:umsmemberstatisticsinfo:update")
    ...
    //@RequiresPermissions("tmall:umsmemberstatisticsinfo:delete")

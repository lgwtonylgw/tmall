 ...
 */
@RestController
@RequestMapping("tmall/omsorderoperatehistory")
public class OmsOrderOperateHistoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("tmall:omsorderoperatehistory:list")
    ...
    //@RequiresPermissions("tmall:omsorderoperatehistory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("tmall:omsorderoperatehistory:save")
    ...
    //@RequiresPermissions("tmall:omsorderoperatehistory:update")
    ...
    //@RequiresPermissions("tmall:omsorderoperatehistory:delete")
